      ...
      (let ((back base03))
        ...
        (let ((bg-back   `(:background ,back))
          ...
          `((;; basic
             ...
             (helm-ff-directory ((t (:inherit eshell-ls-directory-face))))
             (helm-ff-dotted-directory ((t (:inherit eshell-ls-directory-face))))
             (helm-ff-executable ((t (:inherit eshell-ls-executable-face))))
             (helm-ff-file ((t (,@fmt-none))))
             (helm-ff-invalid-symlink ((t (:inherit eshell-ls-missing-face))))
             (helm-ff-prefix ((t (,@fmt-none))))
             (helm-ff-symlink ((t (:inherit eshell-ls-symlink-face))))
