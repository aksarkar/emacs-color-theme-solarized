      ...
      (let ((back base03))
        ...
        (let ((bg-back   `(:background ,back))
          ...
          `((;; basic
             ...
             (link-visited ((t (,@fmt-undr ,@fg-violet))))
             ...
             (info-xref-visited ((t (,@fg-violet :inherit info-xref))))
             (info-node ((t (,@fmt-bold ,@fg-base1))))
             (info-title-1 ((t (:inherit default :height 1.8))))
             (info-title-2 ((t (:inherit default :height 1.4))))
             (info-title-3 ((t (:inherit default :height 1.2))))
             (info-title-4 ((t (:inherit default ,@fmt-bold :height 1.0))))
             ;; org
             ...
             ;; rcirc
             (rcirc-bright-nick ((t (,@fg-cyan))))
             (rcirc-dim-nick ((t (,@fg-base0))))
             (rcirc-my-nick ((t (,@fg-base0))))
             (rcirc-nick-in-message ((t (,@fg-base2 ,@fmt-none))))
             (rcirc-nick-in-message-full-line ((t (,@fg-base2 ,@fmt-none))))
             (rcirc-other-nick ((t (,@fg-base0))))
             (rcirc-prompt ((t (,@fg-base3))))
             ...
             ;; git
             (git-header-face ((t (,@fg-blue ,@fmt-bold))))
             (git-ignored-face ((t (,@fg-base0))))
             (git-mark-face ((t (,@fmt-bold))))
             (git-permission-face ((t (,@fg-green))))
             (git-separator-face ((t (,@fg-base0))))
             ...
             ;; elfeed
             (elfeed-search-date-face ((t (,@fmt-none ,@fg-base0))))
             (elfeed-search-feed-face ((t (,@fmt-none ,@fg-base0))))
             (elfeed-search-tag-face ((t (,@fmt-none ,@fg-blue))))
             (elfeed-search-title-face ((t (,@fmt-none ,@fg-base0))))
             ;; font-latex
             (font-latex-warning-face ((t (,@fg-red))))
             (font-latex-sectioning-5-face ((t (,@fg-violet))))
             (tex-verbatim ((t (,@fmt-none))))
             ;; sh-mode
             (sh-heredoc ((t (:inherit font-lock-string-face))))
             ;; which-function
             (which-func ((t (,@fg-blue))))
             ;; helm
             (helm-action ((t (,@fmt-none :inherit link))))
             (helm-M-x-key ((t (,@fmt-none ,@fg-yellow))))
             (helm-buffer-archive ((t (,@fmt-none))))
             (helm-bookmark-addressbook ((t (,@fmt-none))))
             (helm-bookmark-directory ((t (,@fmt-none))))
             (helm-bookmark-file ((t (,@fmt-none))))
             (helm-bookmark-gnus ((t (,@fmt-none))))
             (helm-bookmark-info ((t (,@fmt-none))))
             (helm-bookmark-man ((t (,@fmt-none))))
             (helm-bookmark-w3m ((t (,@fmt-none))))
             (helm-buffer-directory ((t (,@fmt-none))))
             (helm-buffer-file ((t (,@fmt-none))))
             (helm-buffer-not-saved ((t (,@fmt-none))))
             (helm-buffer-process ((t (,@fmt-none))))
             (helm-buffer-saved-out ((t (,@fmt-none))))
             (helm-buffer-size ((t (,@fmt-none))))
             (helm-candidate-number ((t (,@fmt-none))))
             (helm-etags-file ((t (,@fmt-none))))
             (helm-ff-backup-file ((t (,@fmt-none :inherit font-lock-comment-face))))
             (helm-ff-denied ((t (,@fmt-none ,@fg-red))))
             (helm-ff-directory ((t (,@fg-blue))))
             (helm-ff-dotted-directory ((t (,@fg-blue))))
             (helm-ff-dotted-symlink-directory ((t (,@fg-blue))))
             (helm-ff-executable ((t (,@fg-green))))
             (helm-ff-file ((t (,@fmt-none))))
             (helm-ff-file-extension ((t (,@fmt-none))))
             (helm-ff-invalid-symlink ((t (,@fmt-none ,@fg-red))))
             (helm-ff-pipe ((t (,@fmt-none ,@fg-magenta))))
             (helm-ff-prefix ((t (,@fmt-none))))
             (helm-ff-rsync-progress ((t (,@fg-cyan))))
             (helm-ff-socket ((t (,@fmt-none ,@fg-magenta))))
             (helm-ff-suid ((t (,@bg-red ,@fg-base2))))
             (helm-ff-symlink ((t (,@fg-cyan))))
             (helm-grep-cmd-line ((t (,@fmt-none))))
             (helm-grep-file ((t (,@fmt-none))))
             (helm-grep-finish ((t (,@fmt-none))))
             (helm-grep-lineno ((t (,@fmt-none))))
             (helm-grep-match ((t (,@fmt-none))))
             (helm-grep-running ((t (,@fmt-none))))
             (helm-header ((t (:inherit font-lock-comment-face ,@fmt-bold))))
             (helm-helper ((t (,@fmt-none))))
             (helm-history-deleted ((t (,@fmt-none))))
             (helm-history-remote ((t (,@fmt-none))))
             (helm-lisp-completion-info ((t (,@fmt-none))))
             (helm-lisp-show-completion ((t (,@fmt-none))))
             (helm-locate-finish ((t (,@fmt-none))))
             (helm-match ((t (,@fmt-none))))
             (helm-match-item ((t (,@fmt-none))))
             (helm-mode-prefix ((t (,@bg-red ,@fg-base2))))
             (helm-moccur-buffer ((t (,@fmt-none))))
             (helm-prefarg ((t (,@fmt-none))))
             (helm-resume-need-update ((t (,@fmt-none))))
             (helm-selection ((t (:inherit hl-line))))
             (helm-selection-line ((t (,@fmt-none))))
             (helm-separator ((t (:inherit font-lock-comment-face))))
             (helm-source-header ((t (:inherit mode-line))))
             (helm-visible-mark ((t (,@fmt-none))))
            ...
            ((foreground-color . ,(when (<= 16 (display-color-cells)) base0))
             ...
             (ansi-color-names-vector . [,back ,red ,green ,yellow ,blue ,magenta ,cyan ,base0])
